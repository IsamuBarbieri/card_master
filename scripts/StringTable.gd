...
const TABLE := [
	...
	[
		...
		"Gegnername", "Zum Starten tippen", "Zum Starten klicken", "Titel",
	],
	# English
	[
		...
		"Opponent Name", "Tap to Start", "Click to Start", "Title",
	],
	# Español
	[
		...
		"Nombre del Rival", "Toca para empezar", "Haz clic para empezar", "Título",
	],
	# Français
	[
		...
		"Nom de l'adversaire", "Touchez pour commencer", "Cliquez pour commencer", "Titre",
	],
	# Italiano
	[
		...
		"Nome del Nemico", "Tocca per iniziare", "Clicca per iniziare", "Titolo",
	],
	# Português (Brasil)
	[
		...
		"Nome do Adversário", "Toque para começar", "Clique para começar", "Título",
	],
	# Русский
	[
		...
		"Имя соперника", "Коснитесь, чтобы начать", "Нажмите, чтобы начать", "Заставка",
	],
	...
	[
		...
		"対戦相手の名前", "タップしてスタート", "クリックしてスタート", "タイトル",
	],
	# 简体中文
	[
