...
enum {
	...
	ID_WINS, ID_LAST_SAVED, ID_OWNED,
}
...
const TABLE := [
	...
	[
		...
		"Siege", "Zuletzt gespeichert", "Besitz",
	],
	# English
	[
	...
	[
		...
		"Victorias", "Último guardado", "Poseídas",
	],
	# Français
	[
		...
		"Victoires", "Dernière sauvegarde", "Possédées",
	],
	# Italiano
	[
		...
		"Vittorie", "Ultimo salvataggio", "Possedute",
	],
	# Português (Brasil)
	[
		...
		"Vitórias", "Último salvamento", "Possuídas",
	],
	# Русский
	[
		...
		"Победы", "Последнее сохранение", "В наличии",
	],
